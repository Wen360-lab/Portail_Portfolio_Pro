    ...
    return (
        <section className="flex flex-col items-center justify-center mt-40 md:mt-45 mx-10 gap-3">
            ...
            <motion.div
                ...
                className="relative flex flex-col items-center justify-center bg-background-aera rounded-2xl px-25 py-25 mt-50"
            >
                ...
                <p className="mt-4 text-center text-xl md:text-2xl text-background-dark max-w-2xl">
